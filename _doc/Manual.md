...
For instance, [Hello 2015])(https://drunkxiao.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://drunkxiao.github.io/2019/09/08/spacemacs-workflow/) with
...
It's possible that you want the two things different. For me, my site-title is **“DrunkXiao Blog”** but I want the title shows in search engine is **“ DrunkXiao Blog”** which is multi-language.
...
- Brand new [Archive](https://drunkxiao.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
<img src="http://drunkxiao.github.io/img/blog-md-navbar.gif" width="320" />
