...
我的博客仓库——`DrunkXiao.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`DrunkXiaoblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:DrunkXiao/DrunkXiaoblog-boilerplate.git
```

**[在这里预览模板 &rarr;](http://drunkxiao.github.io/huxblog-boilerplate/)**
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/DrunkXiao/DrunkXiao.github.io/issues/15)
...
看右边:
![](http://drunkxiao.github.io/img/blog-sidebar.jpg)
...
sidebar-avatar: /img/avatar-DrunkXiao.jpg     #你的大头贴，请使用绝对地址.
```
...
![](http://drunkxiao.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://drunkxiao.github.io/js-module-7day/"
---
```
...
ga_domain: drunkxiao.github.io			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/DrunkXiao/DrunkXiao.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“DrunkXiao Blog”** 但是我想要在搜索的时候显示 **“ DrunkXiao Blog”** ，这个就需要SEO Title来定义了。
